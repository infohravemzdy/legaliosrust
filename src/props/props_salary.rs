...
pub trait IPropsSalary : IProps {
    ...
    fn coeff_with_part_and_full_hours(full_work_hours: Decimal, part_work_hours: Decimal) ->  Decimal;
    fn payment_with_monthly_and_full_week_and_full_and_work_hours(amount_monthly: Decimal,
                                                                  full_week_hours: i32, part_week_hours: i32,
                                                                  full_work_hours: i32, part_work_hours: i32) ->  Decimal;
    fn payment_round_up_with_monthly_and_full_week_and_full_and_work_hours(amount_monthly: Decimal,
                                                                           full_week_hours: i32, part_week_hours: i32,
                                                                           full_work_hours: i32, part_work_hours: i32) ->  Decimal;
    fn payment_with_monthly_and_coeff_and_full_and_work_hours(amount_monthly: Decimal,
                                                              monthly_coeff: Decimal, full_work_hours: i32, part_work_hours: i32) ->  Decimal;
    fn payment_round_up_with_monthly_and_coeff_and_full_and_work_hours(amount_monthly: Decimal,
                                                                       monthly_coeff: Decimal, full_work_hours: i32, part_work_hours: i32) ->  Decimal;
    fn payment_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal,
                                                     monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn payment_round_up_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal,
                                                              monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn relative_amount_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn relative_tariff_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn relative_payment_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn reverzed_amount_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn reverzed_tariff_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn reverzed_payment_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) ->  Decimal;
    fn payment_with_tariff_and_hours(tariff_hourly: Decimal, workings_hours: Decimal) ->  Decimal;
    fn payment_round_up_with_tariff_and_hours(tariff_hourly: Decimal, workings_hours: Decimal) ->  Decimal;
    fn tariff_with_payment_and_hours(amount_hourly: Decimal, workings_hours: Decimal) ->  Decimal;
    fn payment_with_amount_fixed(amount_fixed: Decimal) ->  Decimal;
    fn payment_round_up_with_amount_fixed(amount_fixed: Decimal) ->  Decimal;
    fn hours_to_half_hours_up(hours_value: Decimal) ->  Decimal;
    fn hours_to_quart_hours_up(hours_value: Decimal) ->  Decimal;
    fn hours_to_half_hours_down(hours_value: Decimal) ->  Decimal;
    fn hours_to_quart_hours_down(hours_value: Decimal) ->  Decimal;
    fn hours_to_half_hours_norm(hours_value: Decimal) ->  Decimal;
    fn hours_to_quart_hours_norm(hours_value: Decimal) ->  Decimal;
    fn money_to_round_down(money_value: Decimal) ->  Decimal;
    fn money_to_round_up(money_value: Decimal) ->  Decimal;
    fn money_to_round_norm(money_value: Decimal) ->  Decimal;
}
...
impl IPropsSalary for PropsSalary {
    ...
    fn payment_with_monthly_and_coeff_and_full_and_work_hours(amount_monthly: Decimal, monthly_coeff: Decimal, full_work_hours: i32, part_work_hours: i32) -> Decimal {
        let amount_coeffs = Self::factorize_value(amount_monthly, monthly_coeff);
    ...
    fn payment_round_up_with_monthly_and_coeff_and_full_and_work_hours(amount_monthly: Decimal, monthly_coeff: Decimal, full_work_hours: i32, part_work_hours: i32) -> Decimal {
        let amount_coeffs = Self::factorize_value(amount_monthly, monthly_coeff);
    ...
    fn payment_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) -> Decimal {
    ...
    fn payment_round_up_with_monthly_and_coeff_and_work_coeff(amount_monthly: Decimal, monthly_coeff: Decimal, working_coeff: Decimal) -> Decimal {
        let amount_factor = Self::factorize_value(amount_monthly, monthly_coeff);
    ...
    fn payment_with_monthly_and_full_week_and_full_and_work_hours(amount_monthly: Decimal, full_week_hours: i32, part_week_hours: i32, full_work_hours: i32, part_work_hours: i32) -> Decimal {
    ...
    fn payment_round_up_with_monthly_and_full_week_and_full_and_work_hours(amount_monthly: Decimal, full_week_hours: i32, part_week_hours: i32, full_work_hours: i32, part_work_hours: i32) -> Decimal {
        let coeff_salary = Self::coeff_with_part_and_full_hours(Decimal::from_i32(part_week_hours).unwrap(), Decimal::from_i32(full_week_hours).unwrap());
