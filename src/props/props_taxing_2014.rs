...
pub struct PropsTaxing2014 {
    props: PropsTaxingBase,
}

#[allow(dead_code)]
impl PropsTaxing2014 {
    pub(crate) fn new(_version: VersionId,
                      ...
                      _margin_income_of_wth_agr: i32) -> PropsTaxing2014 {
        PropsTaxing2014 {
    ...
    pub(crate) fn empty() -> PropsTaxing2014 {
        PropsTaxing2014 {
...
impl IProps for PropsTaxing2014 {
    fn get_version(&self) -> VersionId {
        self.props.get_version()
    }
}

impl IPropsTaxing for PropsTaxing2014 {
