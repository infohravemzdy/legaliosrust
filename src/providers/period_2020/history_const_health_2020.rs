...
pub(crate) struct HistoryConstHealth2020var06 {
}

impl HistoryConstHealth for HistoryConstHealth2020var06 {
    const VERSION_CODE: i16 = HistoryConstHealth2020::VERSION_CODE;

    const MIN_MONTHLY_BASIS: i32 = HistoryConstHealth2020::MIN_MONTHLY_BASIS;
    ...
    const LIM_MONTHLY_DIS50: i32 = 11607;
    ...
    const MARGIN_INCOME_EMP: i32 = HistoryConstHealth2020::MARGIN_INCOME_EMP;
    const MARGIN_INCOME_AGR: i32 = HistoryConstHealth2020::MARGIN_INCOME_AGR;
}

pub(crate) struct HistoryConstHealth2020 {
}

impl HistoryConstHealth for HistoryConstHealth2020 {
    const VERSION_CODE: i16 = 2020;

    const MIN_MONTHLY_BASIS: i32 = HistoryConstSalary2020::MIN_MONTHLY_WAGE;
    const MAX_ANNUALS_BASIS: i32 = HistoryConstHealth2019::MAX_ANNUALS_BASIS;
    const LIM_MONTHLY_STATE: i32 = HistoryConstHealth2019::LIM_MONTHLY_STATE;
    const LIM_MONTHLY_DIS50: i32 = 7903;
    const FACTOR_COMPOUND: Decimal = HistoryConstHealth2019::FACTOR_COMPOUND;
    const FACTOR_EMPLOYEE: Decimal = HistoryConstHealth2019::FACTOR_EMPLOYEE;
    const MARGIN_INCOME_EMP: i32 = HistoryConstHealth2019::MARGIN_INCOME_EMP;
    const MARGIN_INCOME_AGR: i32 = HistoryConstHealth2019::MARGIN_INCOME_AGR;
}
