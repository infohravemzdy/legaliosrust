...
pub(crate) struct HistoryConstHealth2012 {
}

impl HistoryConstHealth for HistoryConstHealth2012 {
    const VERSION_CODE: i16 = 2012;

    const MIN_MONTHLY_BASIS: i32 = HistoryConstSalary2012::MIN_MONTHLY_WAGE;
    const MAX_ANNUALS_BASIS: i32 = 1809864;
    const LIM_MONTHLY_STATE: i32 = HistoryConstHealth2011::LIM_MONTHLY_STATE;
    const LIM_MONTHLY_DIS50: i32 = HistoryConstHealth2011::LIM_MONTHLY_DIS50;
    const FACTOR_COMPOUND: Decimal = HistoryConstHealth2011::FACTOR_COMPOUND;
    const FACTOR_EMPLOYEE: Decimal = HistoryConstHealth2011::FACTOR_EMPLOYEE;
