...
pub(crate) struct HistoryConstSocial2022 {
}
...
impl HistoryConstSocial for HistoryConstSocial2022 {
    ...
    const FACTOR_EMPLOYEE_REDUCE: Decimal = HistoryConstSocial2021::FACTOR_EMPLOYEE_REDUCE;
    const FACTOR_EMPLOYEE_GARANT: Decimal = HistoryConstSocial2021::FACTOR_EMPLOYEE_GARANT;
    const MARGIN_INCOME_EMP: i32 = HistoryConstSocial2021::MARGIN_INCOME_EMP;
    const MARGIN_INCOME_AGR: i32 = HistoryConstSocial2021::MARGIN_INCOME_AGR;
}
