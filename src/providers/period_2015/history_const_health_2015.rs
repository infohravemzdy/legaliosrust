...
pub(crate) struct HistoryConstHealth2015 {
}

impl HistoryConstHealth for HistoryConstHealth2015 {
    const VERSION_CODE: i16 = 2015;

    const MIN_MONTHLY_BASIS: i32 = HistoryConstSalary2015::MIN_MONTHLY_WAGE;
    ...
    const LIM_MONTHLY_DIS50: i32 = HistoryConstHealth2014var07::LIM_MONTHLY_DIS50;
