...
pub(crate) struct HistoryConstSalary2016 {
}

impl HistoryConstSalary for HistoryConstSalary2016 {
    const VERSION_CODE: i16 = 2016;

    const WORKING_SHIFT_WEEK: i32 = HistoryConstSalary2015::WORKING_SHIFT_WEEK;
    const WORKING_SHIFT_TIME: i32 = HistoryConstSalary2015::WORKING_SHIFT_TIME;
    const MIN_MONTHLY_WAGE: i32   = 9900;
    const MIN_HOURLY_WAGE: i32    = 5870;
}
