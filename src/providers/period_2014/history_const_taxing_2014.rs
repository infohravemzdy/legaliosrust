...
impl HistoryConstTaxing for HistoryConstTaxing2014 {
    ...
    const FACTOR_TAXRATE2: Decimal = HistoryConstTaxing2013::FACTOR_TAXRATE2;
    ...
    const MARGIN_INCOME_OF_TAXRATE2: i32 = HistoryConstTaxing2013::MARGIN_INCOME_OF_TAXRATE2;
