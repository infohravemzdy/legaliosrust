...
pub(crate) struct HistoryConstHealth2010 {
}

impl HistoryConstHealth for HistoryConstHealth2010 {
    ...
    const MARGIN_INCOME_AGR: i32 = HistoryConstHealth2010::MARGIN_INCOME_EMP;
}
