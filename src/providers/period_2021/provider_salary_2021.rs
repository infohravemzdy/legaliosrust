...
pub(crate) struct ProviderSalary2021 {
    version: VersionId
}

#[allow(dead_code)]
impl ProviderSalary2021 {
    pub(crate) fn new() -> ProviderSalary2021 {
        ProviderSalary2021 {
            version: VersionId::get(HistoryConstSalary2021::VERSION_CODE)
        }
    }
    fn working_shift_week(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2021::WORKING_SHIFT_WEEK
    }

    fn working_shift_time(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2021::WORKING_SHIFT_TIME
    }
    fn min_monthly_wage(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2021::MIN_MONTHLY_WAGE
    }
    fn min_hourly_wage(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2021::MIN_HOURLY_WAGE
    }
}

impl IProps for ProviderSalary2021 {
    fn get_version(&self) -> VersionId {
        self.version
    }
}

impl IPropsProvider<PropsSalary> for ProviderSalary2021 {
    fn get_version(&self) -> VersionId {
        self.version
    }
