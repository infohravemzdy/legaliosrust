...
pub(crate) struct ProviderSalary2019 {
    version: VersionId
}

#[allow(dead_code)]
impl ProviderSalary2019 {
    pub(crate) fn new() -> ProviderSalary2019 {
        ProviderSalary2019 {
            version: VersionId::get(HistoryConstSalary2019::VERSION_CODE)
        }
    }
    fn working_shift_week(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2019::WORKING_SHIFT_WEEK
    }

    fn working_shift_time(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2019::WORKING_SHIFT_TIME
    }
    fn min_monthly_wage(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2019::MIN_MONTHLY_WAGE
    }
    fn min_hourly_wage(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSalary2019::MIN_HOURLY_WAGE
    }
}

impl IProps for ProviderSalary2019 {
    fn get_version(&self) -> VersionId {
        self.version
    }
}

impl IPropsProvider<PropsSalary> for ProviderSalary2019 {
    fn get_version(&self) -> VersionId {
        self.version
    }
