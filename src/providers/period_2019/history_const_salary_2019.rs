...
pub(crate) struct HistoryConstSalary2019 {
}

impl HistoryConstSalary for HistoryConstSalary2019 {
    const VERSION_CODE: i16 = 2019;

    const WORKING_SHIFT_WEEK: i32 = HistoryConstSalary2018::WORKING_SHIFT_WEEK;
    const WORKING_SHIFT_TIME: i32 = HistoryConstSalary2018::WORKING_SHIFT_TIME;
    const MIN_MONTHLY_WAGE: i32   = 13350;
    const MIN_HOURLY_WAGE: i32    = 7980;
}
