...
pub(crate) struct ProviderSocial2019 {
    version: VersionId
}

#[allow(dead_code)]
impl ProviderSocial2019 {
    pub(crate) fn new() -> ProviderSocial2019 {
        ProviderSocial2019 {
            version: VersionId::get(HistoryConstSocial2019::VERSION_CODE)
        }
    }
    fn max_annuals_basis(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSocial2019::MAX_ANNUALS_BASIS
    }

    fn factor_employer(&self, _period: &dyn IPeriod) -> Decimal {
        if _period.is_period_greater_or_equal_than(2019, 7) {
            return HistoryConstSocial2019var07::FACTOR_EMPLOYER;
        }
        HistoryConstSocial2019::FACTOR_EMPLOYER
    }

    fn factor_employer_higher(&self, _period: &dyn IPeriod) -> Decimal {
        HistoryConstSocial2019::FACTOR_EMPLOYER_HIGHER
    }

    fn factor_employee(&self, _period: &dyn IPeriod) -> Decimal {
        HistoryConstSocial2019::FACTOR_EMPLOYEE
    }

    fn factor_employee_garant(&self, _period: &dyn IPeriod) -> Decimal {
        HistoryConstSocial2019::FACTOR_EMPLOYEE_GARANT
    }

    fn factor_employee_reduce(&self, _period: &dyn IPeriod) -> Decimal {
        HistoryConstSocial2019::FACTOR_EMPLOYEE_REDUCE
    }

    fn margin_income_emp(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSocial2019::MARGIN_INCOME_EMP
    }

    fn margin_income_agr(&self, _period: &dyn IPeriod) -> i32 {
        HistoryConstSocial2019::MARGIN_INCOME_AGR
    }
}

impl IProps for ProviderSocial2019 {
    fn get_version(&self) -> VersionId {
        self.version
    }
}

impl IPropsProvider<PropsSocial> for ProviderSocial2019 {
    fn get_version(&self) -> VersionId {
        self.version
    }
