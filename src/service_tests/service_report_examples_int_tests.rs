...
mod service_examples_tests {
    #[macro_export]
    macro_rules! report_test_examples_int_salary {
                ...
                fn $name() -> Result<(), Box<dyn Error>> {
                    ...
                    for exp_year in $year_from..$year_ends {
                        ...
                        for exp_month in 1i16..13i16 {
                            ...
                            write_report_year_int_value(&mut file, result_value);
                        }
    ...
    #[macro_export]
    macro_rules! report_test_examples_int_health {
        ($suite:ident, $name:ident, $name_str:expr, $test: expr, $year_from: expr, $year_ends: expr) => {
            mod $suite {
                use std::error::Error;
    ...
    #[macro_export]
    macro_rules! report_test_examples_int_social {
        ($suite:ident, $name:ident, $name_str:expr, $test: expr, $year_from: expr, $year_ends: expr) => {
            mod $suite {
                use std::error::Error;
    ...
    #[macro_export]
    macro_rules! report_test_examples_int_taxing {
        ($suite:ident, $name:ident, $name_str:expr, $test: expr, $year_from: expr, $year_ends: expr) => {
            mod $suite {
                use std::error::Error;
