...
mod service_tests {
    ...
    crate::test_examples_int_health! (test_examples_2010, |x: &dyn IPropsHealth| {x.margin_income_emp()},
        margin_income_emp_test_period_2010_01: 2010, 1, 2010, 1, 2000,
        margin_income_emp_test_period_2010_02: 2010, 2, 2010, 2, 2000,
        margin_income_emp_test_period_2010_03: 2010, 3, 2010, 3, 2000,
        margin_income_emp_test_period_2010_04: 2010, 4, 2010, 4, 2000,
        margin_income_emp_test_period_2010_05: 2010, 5, 2010, 5, 2000,
        margin_income_emp_test_period_2010_06: 2010, 6, 2010, 6, 2000,
        margin_income_emp_test_period_2010_07: 2010, 7, 2010, 7, 2000,
        margin_income_emp_test_period_2010_08: 2010, 8, 2010, 8, 2000,
        margin_income_emp_test_period_2010_09: 2010, 9, 2010, 9, 2000,
        margin_income_emp_test_period_2010_10: 2010, 10, 2010, 10, 2000,
        margin_income_emp_test_period_2010_11: 2010, 11, 2010, 11, 2000,
        margin_income_emp_test_period_2010_12: 2010, 12, 2010, 12, 2000,
    );
    crate::test_examples_int_health! (test_examples_2011, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2012, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2013, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2014, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2015, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2016, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2017, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2018, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2019, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2020, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2021, |x: &dyn IPropsHealth| {x.margin_income_emp()},
    ...
    crate::test_examples_int_health! (test_examples_2022, |x: &dyn IPropsHealth| {x.margin_income_emp()},
